  ...
  const favoriteArtists = [
    {
      ...
      name: "Ice Nine Kills",
      subscribers: "432k",
      img: "https://pixaab.com/wp-content/uploads/2023/08/for-real-album-cover-art-psd1-templates-pixaab-Large.jpeg",
    },
    {
      id: 2,
      name: "Bloodywood",
      subscribers: "31k",
      img: "https://i.scdn.co/image/ab67616d00001e0267cf92b139a3d7ea71a54118",
    },
    {
      id: 3,
      name: "Bad Omens",
      subscribers: "183k",
      img: "https://i.namu.wiki/i/8mnP9gM3Wx2DZ4E_LKe_3Ux4Ul4NgXbweG0g1EaJoZeJO7m-W3scJ0dWxjku2X7Ia-9wK_E-_G246VNHWqYaZA.webp",
    },
    {
      id: 4,
      name: "Lorna Shore",
      subscribers: "108k",
      img: "https://cdns-images.dzcdn.net/images/cover/a8723e5f960532cf3f4491f6e9aa3b41/0x1900-000000-80-0-0.jpg",
    },
    {
      id: 5,
      name: "Anniskokay",
      subscribers: "79k",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTt6sqorNDfKhAQM1KJHb9vdPriZ3UafojQDQ&s",
    },
  ];
  ...
  const newReleases = [
    {
      ...
      title: "Calamity",
      artist: "Amisokay",
      img: "https://image-cdn-ak.spotifycdn.com/image/ab67706c0000da8430e0999f7f2bd261980eac13",
    },
    {
      id: 2,
      title: "Last Resort",
      artist: "Reimagined",
      img: "https://i.scdn.co/image/ab67616d00001e02df18d3c75fb64b5060f1e690",
    },
  ];
  const listenMoreOften = [
    {
      id: 1,
      title: "Blood Orange",
      artist: "Berried Alive",
      img: "https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/b7fd92108782021.5fc5820ec90ba.png",
    },
    {
      id: 2,
      title: "Soul Decay",
      artist: "Make Them Suffer",
      img: "https://i.scdn.co/image/ab67616d00001e02e4179b3fb74beaf0cdfa7a13",
    },
  ];
...
<div className="  min-w-72 ml-3    flex flex-col  gap-2  px-4  ">
  ...
  {/* Map through favoriteArtists array */}
